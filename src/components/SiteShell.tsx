...
export default function SiteShell({ current, children }: Props) {
  return (
    <main className="relative min-h-screen overflow-hidden px-4 py-8">
      ...
      <div className="grain panel-dawn relative z-10 mx-auto w-full max-w-[1100px] overflow-hidden rounded-[36px] bg-[#0f0c0a]/90 p-6 shadow-[0_50px_120px_-40px_rgba(0,0,0,0.85)] ring-1 ring-white/10 sm:p-10">
        <div
          aria-hidden
          className="absolute inset-x-10 top-0 h-px bg-gradient-to-r from-orange-500/0 via-orange-300/80 to-fuchsia-400/0"
        />
        <header className="relative z-10 flex flex-wrap items-center justify-between gap-4">
          ...
          >
            kochi<span className="ink-dawn">.buzz</span>
          </Link>
